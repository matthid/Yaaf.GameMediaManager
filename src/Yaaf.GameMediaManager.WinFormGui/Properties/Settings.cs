namespace Yaaf.GameMediaManager.WinFormGui.Properties {
    ...
    public sealed partial class Settings {
        public void SetProjectDefaults()
        {
            ...
            {
                SettingsVersion = ProjectConstants.VersionString;
            }

            if (string.IsNullOrEmpty(DatabaseSchemaVersion))
            {
                DatabaseSchemaVersion = ProjectConstants.DatabaseSchemaVersionString;
            }
        }
